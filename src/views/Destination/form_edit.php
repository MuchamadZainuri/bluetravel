<div id="edit-modal-<?= $no ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-3 w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="<?= BASEURL . 'destination/edit' ?>" method="post" autocomplete="off" enctype="multipart/form-data" spellcheck="false">
                <div class="grid gap-4 mb-4 grid-cols-4">
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="name" value="<?= $destination["name"] ?>" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="Gunung Bromo" required autofocus maxlength="40">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <select name="city_id" id="city_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" required>
                            <?php foreach ($cities as $city) : ?>
                                <option value="<?= $city['id'] ?>" <?= $city['id'] == $destination['city_id'] ? 'selected' : '' ?>><?= $city['name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" name="open-time" value="<?= $destination['open_time'] ?>" id="open-time" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="06:00" max="18:00" value="00:00" required />
                        </div>
                    </div>
                    <div class="col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" name="close-time" value="<?= $destination['close_time'] ?>" id="close-time" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="12:00" max="23:00" value="00:00" required />
                        </div>
                    </div>
                    <div class="col-span-2">
                        ...
                        <textarea name="short-description" id="short-description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="Gunung Bromo adalah gunung berapi aktif di Jawa Timur, Indonesia." required><?= json_decode($destination["descriptions"])[0] ?></textarea>
                    </div>
                    <div class="col-span-2">
                        <label for="long-description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi Panjang</label>
                        <textarea name="long-description" id="long-description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="Gunung Bromo adalah gunung berapi aktif di Jawa Timur, Indonesia. juga merupakan salah satu destinasi wisata yang paling populer di Indonesia. alam yang indah dan pemandangan mata hari terbit yang menakjubkan." required><?= json_decode($destination["descriptions"])[1] ?></textarea>
                    </div>
                    <div class="col-span-1">
                        <label for="cover" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cover</label>
                        <input type="file" name="cover" id="cover" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" accept="image/jpeg,image/png,image/jpg,image/webp">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">Pilih file jika ingin mengganti Cover</p>
                    </div>
                    <div class="col-span-1">
                        <label for="image1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image 1</label>
                        <input type="file" name="image1" id="image1" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" accept="image/jpeg,image/png,image/jpg,image/webp">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">Pilih file jika ingin mengganti Image 1</p>
                    </div>
                    <div class="col-span-1">
                        <label for="image2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image 2</label>
                        <input type="file" name="image2" id="image2" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" accept="image/jpeg,image/png,image/jpg,image/webp">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">Pilih file jika ingin mengganti Image 2</p>
                    </div>
                    <div class="col-span-1">
                        <label for="image3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image 3</label>
                        <input type="file" name="image3" id="image3" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" accept="image/jpeg,image/png,image/jpg,image/webp">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">Pilih file jika ingin mengganti Image 3</p>
                    </div>
                    <div class="col-span-1">
                        <label for="video1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Video 1</label>
                        <input type="url" name="video1" value="<?= json_decode($destination['videos'])[0] ?>" id="video1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="https://www.youtube.com/embed/d_VCZvcZJBo?si=FQidVIYurV" required>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="url" name="video2" value="<?= json_decode($destination['videos'])[1] ?>" id="video2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="https://www.youtube.com/embed/d_VCZvcZJBo?si=FQidVIYurV">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">Gunakan link embed video dari YouTube.</p>
                    </div>
                    <div class="col-span-1">
                        <label for="video3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Video 3</label>
                        <input type="url" name="video3" value="<?= json_decode($destination['videos'])[2] ?>" id="video3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="https://www.youtube.com/embed/d_VCZvcZJBo?si=FQidVIYurV">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">Gunakan link embed video dari YouTube.</p>
                    </div>
                    <div class="col-span-1">
                        <label for="tags" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tags</label>
                        <input type="text" name="tags" value="<?= implode(', ', json_decode($destination["tags"])) ?>" id="tags" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="Gunung, Bromo, Jawa Timur" required>
